...
- Bouldering uses a two-day streak interval:
  - completing it every other day keeps the streak alive
  - all other habits still use the daily streak rule
...
- The starter data currently inserts example habits named `Roblox`, `Manga`, `Mewing`, and `Bouldering`
